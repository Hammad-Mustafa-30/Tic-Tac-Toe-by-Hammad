...
void set_mainScreen1() {
	...
	setbkcolor(CYAN);						 //puts background color
	setfillstyle(XHATCH_FILL, BLACK);		//fills the given area with color and texture
	bar(0,0,XP,YP);			  			   //creates a rectangle filled with color at the given location
...
///////////////////// THE ISSUE HERE IS THAT I WANT THIS FUNCTION TO WAIT FOR RIGHT MOUSE CLICK
